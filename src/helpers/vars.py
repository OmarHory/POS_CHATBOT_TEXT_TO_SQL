...
def gpt_sql_prompt(
    ...
    prompt_temp = f"""
        ...
        3- Examples:
                ...
                - Question: Compare yesterdays sales per item with its daily sales from June 2023. And highlight some key changes, for example, highest growth item, highest decrease in sales, etc.
